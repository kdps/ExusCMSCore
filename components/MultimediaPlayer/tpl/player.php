<div id="video_container">
	...
	<video id="audio_player" preload webkit-playsinline playsinline poster="<?php echo $this->base->get('image_url'); ?>">
	...
	<div id="controlBox">
		...
		<div class="player" id="videoControls">
			...
			<button id="windowMode" title="윈도우 모드"><i class="fa fa-desktop" aria-hidden="true"></i></button>
...
$(document).ready(function() {
	...
	window.initVideo();
	<?php if ($this->base->get('isVideo') === false): ?>
	$.core.Lyrics.getLyricsData('<?php echo $this->base->get('lyricssrl'); ?>');
	<?php else: ?>
	$.core.Lyrics.setOnlyEqualizer();
	<?php endif;?>
});
</script>