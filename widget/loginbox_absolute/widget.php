		...
		<input type="hidden" name="url" value="">
			...
			<div class="login-misc font-12 text-muted ellipsis">
				...
				<div class="pull-right text-muted">
					<a href="<?php echo str::getUrl('md','member','act','dispMemberNaverLogin');?>">
						<span class="text-muted">네이버 로그인</span>
					</a>
					<span class="bar">|</span>
					<a href="<?php echo str::getUrl('md','member','act','dispMemberSignin');?>">
						<span class="text-muted">회원가입</span>
					</a>
					<span class="bar">|</span>
					<a href="" class="win_password_lost">
						<span class="text-muted">정보찾기</span>
					</a>
				</div>
