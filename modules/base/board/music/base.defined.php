<?php
	...
	define('__SKIN_XML__', "%s/skin.xml");
	define('__COMMENT_TPL__', "%s/ext/comment.php");
	define('__TAG_TPL__', "%s/tag.php");
	define('__ALBUM_TPL__', "%s/album.php");
	define('__ORIGIN_TPL__', "%s/origin.php");
	define('__WRITE_TPL__', "%s/write.php");
	...
	define('__DEFAULT_XML__', 'xml/default.xml');
