		...
		<div id="bd" class="bd">
			...
			<form id="form_doc" action="index.php" onsubmit="return submitFilter(this)" enctype="multipart/form-data" class="bd_wrt bd_wrt_main clear" method="post">
				...
				<div style="margin:0;padding:0" class="content_document">
					<table class="bd_tb extravars_td" style="display: table;">
						<tbody>
						<?php foreach($this->board->extra_var as $evar):?>
							<tr>
								<th style="background-color:#fff" scope="row">
									<?php echo $evar->getTitle(); ?>
								</th>
								<td style="background-color:#fff">
									<?php echo $evar->getInputTag(); ?>
								</td>
							</tr>
						<?php endforeach;?>
						</tbody>
