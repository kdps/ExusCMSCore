...
<div class="list_area">
	<div class="content newclearfix">
		<?php if(isset($this->board->config->top_html)):?>
			<?php echo $this->board->config->top_html;?>
		<?php endif;?>
		...
		<?php if(isset($this->board->config->bottom_html)):?>
			<?php echo $this->board->config->bottom_html;?>
		<?php endif;?>
   </div>
</div>