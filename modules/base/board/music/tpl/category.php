<?php
	...
	$this->base->addJS("/common/assets/js/jstree/jstree.js", 'head');
	$this->base->addCSS("/common/assets/css/jquery.simple.tree.css");
	$this->base->addCSS("/common/assets/js/themes/default/style.css");
