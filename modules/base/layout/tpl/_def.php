...
<?php endforeach;?>
	...
	<!--[if lt IE 9]>
		<script src="./common/assets/js/html5shiv/html5shiv.min.js"></script>
		<script src="./common/assets/js/response/response.min.js"></script>
	<![endif]-->
	<!--[if IE 9]>
		<script src="./common/assets/js/ie/ie9.js"></script>
	<![endif]-->
	<!--[if IE 8]>
		<script src="./common/assets/js/ie/ie8.js"></script>
	<![endif]-->
	<!--[if IE 7]>
		<script src="./common/assets/js/ie/ie7.js"></script>
	<![endif]-->
