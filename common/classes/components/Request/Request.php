...
class request {
	...
	public static function getHeaderMessage($msg) {
	...
	public static function hasEnv($header) {
	...
	public static function decodeBinaryNumbericPassword($input_value, $password) {
	...
	public static function encodeBinaryNumbericPassword($input_value, $password) {
